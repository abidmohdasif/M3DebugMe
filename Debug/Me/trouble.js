let v1 = 3;
let v2 = 4
alert("3 times 4" + " equals " + v1 * v2); // Uncommented the alert and equals needed quotations

 // This sets the general styling for the divs within the section tag using .style
            let section = document.getElementById("s1") // Got rid of the "s" at the end of
            section.style.width = "50%"
            section.style.textAlign = "center"
            section.style.fontFamily = "arial, serif"
            section.style.fontWeight = "bold" // Corrected the Spelling for "style"
            ...
            // RED
            const red = document.getElementById("red")  //Capatalize the "e"
            red.innerHTML = "RED"
            red.style.backgroundColor = "red"

            // ORANGE
            const orange = document.getElementById("orange")
            orange.innerHTML = "ORANGE" // Capatalize the "html"
            ...
            // GREEN
            const green = document.getElementById("green") // Change the color from purple to green
